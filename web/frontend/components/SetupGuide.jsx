...
// export const MenuHorizontalSvg = () => (
//     <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
//         <path d="M3 6h14M3 10h14M3 14h14" stroke="#6D7175" strokeWidth="2" strokeLinecap="round" />
//     </svg>
// );

export const ChevronDownSvg = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M6 8l4 4 4-4" stroke="#6D7175" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const ChevronUpSvg = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M6 12l4-4 4 4" stroke="#6D7175" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const CheckSvg = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <circle cx="10" cy="10" r="9" fill="#303030" />
        <path d="M6 10l3 3 7-7" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);

export const XSvg = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        <path d="M6 6l8 8M6 14L14 6" stroke="#6D7175" strokeWidth="2" strokeLinecap="round" />
    </svg>
);
                ...
                <BlockStack>
                    <InlineStack align='space-between' blockAlign='center'>
                        ...
                        <ButtonGroup gap='tight' noWrap>
                            ...
                            {/* <Button
                                variant='tertiary'
                                icon={isGuideOpen ? ChevronUpSvg : ChevronDownSvg}
                                onClick={() => {
                                    setIsGuideOpen((prev) => {
                        ...
                        <InlineStack blockAlign='center' gap='200'>
                            {completedItemsLength === items.length ? (
                                ...
                                <Text as='span' variant='bodySm'>
                                    {`${completedItemsLength} / ${items.length}`} {t("dashboard.completed")}
                                </Text>
                            )}
            ...
            {completedItemsLength === items.length ? (
                ...
                >
                    <InlineStack align='end'>
                        <Button onClick={onDismiss}>{t("dashboard.dismiss_guide")}</Button>
                    </InlineStack>
                </Box>
            ) : null}
        </Card>
...
const SetupItem = ({ complete, onComplete, expanded, setExpanded, title, description, image, primaryButton, secondaryButton, tertiaryButton, id }) => {
        ...
        <Box borderRadius='200' background={expanded && 'bg-surface-active'}>
            <div className={`${styles.setupItem} ${expanded ? styles.setupItemExpanded : ""}`}>
                <InlineStack gap='200' align='start' blockAlign='start' wrap={false}>
                    <Tooltip content={complete ? t("dashboard.mark_as_not_done") : t("dashboard.mark_as_done")} activatorWrapper='div'>
